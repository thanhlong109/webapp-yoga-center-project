                    ...
                    <c:forEach items="${blogList}" var="blog">
                        <div class="blog-item">                  
                            <div class="blog-item-img">
                                <img src="${pageContext.request.contextPath}/Asset/img/blog/${blog.img}" alt="">
                            </div>
                            <div class="blog-item-body">
                                ...
                                <a href="BlogHomeDetail" class="read-more-btn">Read More 
            ...
            <div class="right-container">
                ...
                <div class="box-section">
                    ...
                    <div class="small-blog-item">
                        ...
                        <div>
                            <a href="BlogHomeDetail">Is Information Overload Making it Harder to be Happy?</a>
                    ...
                    <div class="small-blog-item">
                        ...
                        <div>
                            <a href="BlogHomeDetail">The Difference Between Yoga and Yoga Therapy</a>
                            <div class="small-blog-item-info">
                                <div><i class="fa-regular fa-clock"></i> July 31, 2020</div>
                                <div><i class="fa-solid fa-pen"></i> James Smith</div>
                            </div>
                    ...
                    <div class="small-blog-item">
                        ...
                        <div>
                            <a href="BlogHomeDetail">Yin Yoga 101 with Josh Summers</a>
                            <div class="small-blog-item-info">
                                <div>
                                    <i class="fa-regular fa-clock"></i> July 31, 2020
                                </div>
                                <div>
                                    <i class="fa-solid fa-pen"></i> James Smith
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="post-blog-container">
                    ...
                    <form action="BlogHome">
                        ...
                        <div class="img-label">
                            ...
                            <label class="uploadImg" for="jsuploadImg">
