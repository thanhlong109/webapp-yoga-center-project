 ...
 * @author localboss
 */
public class SearchMembershipCashierController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String searchMembership = request.getParameter("search-membership");
        MembershipRepository _membershipRepository = new MembershipRepository();
        List<Membership> result = _membershipRepository.searchName(searchMembership);
