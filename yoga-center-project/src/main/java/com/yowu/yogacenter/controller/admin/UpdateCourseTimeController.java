 ...
 * @author DungVNT
 */
public class UpdateCourseTimeController extends HttpServlet {

    private final String EDIT_PAGE = "../Admin/EditCourseTime.jsp";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        CourseSchedule cs = _courseScheduleRepository.detail(id);
        request.setAttribute("COURSE_SCHEDULE", cs);
